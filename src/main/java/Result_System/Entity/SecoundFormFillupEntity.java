...
@Entity
@Table(name="Secound_Semester_FormFillup")
public class SecoundFormFillupEntity {
	...
	public SecoundFormFillupEntity() {
		super();
		// TODO Auto-generated constructor stub
	}


	public SecoundFormFillupEntity(Long iD, String session, String name, String address, String email, String phone,
	...
	public String toString() {
		return "SecoundFormFillupEntity [ID=" + ID + ", session=" + session + ", name=" + name + ", address=" + address

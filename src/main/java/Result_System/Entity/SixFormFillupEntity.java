...
@Entity
@Table(name="Six_Semester_FormFillup")
public class SixFormFillupEntity {
	...
	public SixFormFillupEntity() {
		super();
		// TODO Auto-generated constructor stub
	}


	public SixFormFillupEntity(Long iD, String session, String name, String address, String email, String phone,
	...
	public String toString() {
		return "SixFormFillupEntity [ID=" + ID + ", session=" + session + ", name=" + name + ", address=" + address

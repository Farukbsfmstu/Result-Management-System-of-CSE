...
@Entity
@Table(name="Seven'th_Semester_FormFillup")
public class SevenFormFillupEntity {
	@Id  
    private Long ID;
	...
	public SevenFormFillupEntity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public SevenFormFillupEntity(Long iD, String session, String name, String address, String email, String phone,
	...
	public String toString() {
		return "SevenFormFillupEntity [ID=" + ID + ", session=" + session + ", name=" + name + ", address=" + address

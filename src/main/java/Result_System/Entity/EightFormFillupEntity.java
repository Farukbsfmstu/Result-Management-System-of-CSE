...
@Entity
@Table(name="Eighth_Semester_FormFillup")
public class EightFormFillupEntity {
	...
	public EightFormFillupEntity() {
		super();
		// TODO Auto-generated constructor stub
	}


	public EightFormFillupEntity(Long iD, String session, String name, String address, String email, String phone,
	...
	public String toString() {
		return "EightFormFillupEntity [ID=" + ID + ", session=" + session + ", name=" + name + ", address=" + address
